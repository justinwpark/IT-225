...
try {
    ...
    $sql = "INSERT INTO USER (ACU_USERNAME, FIRST_NAME, LAST_NAME, EMAIL_ADDRESS)
    VALUES ('$ACU_USERNAME', '$FIRST_NAME', '$LAST_NAME', '$EMAIL_ADDRESS')";
...
<div class="Form">
  <form id="myForm" action="P2_rvs3.php" method="POST"> 
	<button type="button" onclick='myFunction()' value="Submit">Submit</button>
		...
		<input type="hidden" id="ACU_USERNAME" name="ACU_USERNAME" value='<?php echo $_POST["username"]; ?>'>
